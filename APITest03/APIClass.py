...
class TeacherMgr(APIBase):
    ...
    def list_teacher(self,pagenum=1,pagesize=20):
        ...
        resp=requests.get('http://localhost:8080/api/mgr/sq_mgr/',params=params,headers=head,cookies={"sessionid":self.sessionid})
        print('列出教师返回：',resp.json())
        return resp.json()
    def modify_teacher(self,id,username,password,realname,desc,courses,display_idx):
        payload={
        ...
        resp=requests.put('http://localhost:8080/api/mgr/sq_mgr/',data=payload,headers=head,cookies={"sessionid":self.sessionid})
        print('修改教师返回：',resp.json())
        return resp.json()
    def delete_teacher(self,id):
        ...
        resp=requests.delete('http://localhost:8080/api/mgr/sq_mgr/',data=payload,headers=head,cookies={"sessionid":self.sessionid})
        print('删除教师返回：',resp.json())
        return resp.json()
